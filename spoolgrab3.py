...
URL="https://printermaterials.com/empty-spool-weight-database/"
LOCAL_FILENAME="empty-spool-weight-database.html"
DB_PATH="spool_weights3.db"
...
def create_spools_db_from_wiki():
    ...
    spools_data = bs_object.find("table", attrs={"id": "tablepress-48"}).find("tbody")
